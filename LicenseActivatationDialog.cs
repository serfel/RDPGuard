...
internal sealed class LicenseActivatationDialog : Form0
{
	private sealed class Class21
	{
		...
		{
			form30_0.InitializeComponents(object_0, eventArgs11_0);
		}
	}
	...
	private void OnCheckedChanged()
	{
		...
		string text = (class62_1.Text = "RdpGuard Activation");
		string text3 = text;
		Text = text3;
	...
	private void method_23()
	{
		...
		gclass3_1.Text = "Click here to deactivate your License key on this computer.";
