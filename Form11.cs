...
internal sealed class Pop3SettingsDialog : Form0
{
	...
	private void method_12()
	{
		...
		control10_0.Event_1 += method_17;
		control10_0.Event_0 += method_18;
	...
	private void method_14()
	{
		...
		class62_1.Text = "Configure POP3 protection settings";
		...
		class65_0.Text = "Select monitoring method for POP3 protocol:";
		...
		class63_0.Text = "Works with particular POP3 server's logs, SSL/TLS connections are supported.";
		...
		class63_1.Text = "Works with any POP3 Server. SSL/TLS connections are not supported.";
		...
		class63_2.Text = "Turn on to enable POP3 protection";
		...
		class61_0.Text = "Enable POP3 protection";
