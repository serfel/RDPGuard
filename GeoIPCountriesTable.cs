...
internal sealed class GeoIPCountriesTable : UserControl
{
	...
	private sealed class _003C_003Ec
	{
		...
		internal bool InitializeHandlers(ListViewItem listViewItem_0)
		{
			return listViewItem_0.Tag is GClass5;
		}

		internal GClass5 AddItems(ListViewItem listViewItem_0)
		{
			return listViewItem_0.Tag as GClass5;
		}

		internal bool AddItem(ListViewItem listViewItem_0)
		{
			return listViewItem_0.Tag is GClass5;
		}

		internal GClass5 UpdateCustomList(ListViewItem listViewItem_0)
		{
			return listViewItem_0.Tag as GClass5;
		}

		internal bool RemoveSelected(ListViewItem listViewItem_0)
		{
			return listViewItem_0.Tag is List<IPListEntry>;
		}

		internal bool RemoveItem(ListViewItem listViewItem_0)
		{
			return listViewItem_0 is Class7;
		}

		internal bool UpdateTotals(ListViewItem listViewItem_0)
		{
			return listViewItem_0 is Class8;
		}

		internal GStruct1 InitializeComponent(IPListEntry iplistEntry_0)
		{
			return iplistEntry_0.gclass24_0.GStruct1_2;
		}

		internal void RemoveListItem(ListViewItem listViewItem_0)
		{
			listViewItem_0.Remove();
		}

		internal long RemoveCountry(GClass5 gclass5_0)
		{
			return gclass5_0.long_0;
		}

		internal long GetEntryCount(GClass5 gclass5_0)
		{
			return gclass5_0.long_1;
		}

		internal GStruct1 GetAddressCount(IPListEntry iplistEntry_0)
		{
			return iplistEntry_0.gclass24_0.GStruct1_2;
		}
	}
	...
	public void UpdateCustomList(IPListEntry[] iplistEntry_0)
	{
		if (!iplistEntry_0.IsNullOrEmpty())
		{
			...
			Func<IPListEntry, GStruct1> selector = _003C_003Ec._003C_003E9.InitializeComponent;
	...
	private void UpdateTotals()
	{
		...
		if (GClass5_1.Length + (Boolean_1 ? 1 : 0) >= 2)
		{
			...
			Func<GClass5, long> selector2 = _003C_003Ec._003C_003E9.GetEntryCount;
			GStruct1 gStruct = (GStruct1)gClass5_2.Select(selector2).Sum();
			IPListEntry[] iPListEntry_ = IPListEntry_0;
			Func<IPListEntry, GStruct1> selector3 = _003C_003Ec._003C_003E9.GetAddressCount;
	...
	private void RemoveListItem(GClass5 gclass5_0)
	{
		AddItem(gclass5_0);
	}

	private void RemoveCountry(GClass5 gclass5_0)
	{
		RemoveItem(gclass5_0);
	}
}
