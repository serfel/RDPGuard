...
internal sealed class MySqlSettingsDialog : Form0
{
	...
	private void InitializeComponent()
	{
		...
		class62_1"Advanced MySQL protection settings";
		...
		class61_0"Enable MySQL protection";
		...
		class61_1"Automatically detect config file location";
		...
		class63_0"Turn on to enable MySQL protection";
		...
		class63_1"RdpGuard will detect my.ini (my.cnf) location automatically";
		...
		class62_2"Config file location:";
		...
		class63_2"You can specify location of my.ini (my.cnf) manually";
		...
		class63_3"You can specify location of general log file manually. General logging must be enabled.";
		...
		class62_3"General log file location:";
		...
		class63_4"RdpGuard will detect general log file location automatically";
		...
		class61_2"Automatically detect general log file location";
		...
		class63_5"Works with all MySQL editions. May work slow on heavy loaded MySQL servers.";
		...
		class63_6"Works with MySQL 5.7 and higher. Faster and less resource consuming. Recommended.";
		...
		class64_1"Application Event Log";
		...
		class62_4"Select monitoring method";
