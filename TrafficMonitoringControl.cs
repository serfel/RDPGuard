...
internal sealed class TrafficMonitoringControl : Control2
{
	...
	private void InitializeComponent()
	{
		...
		class65_0"{MONITORING_METHOD_CAPTION}";
		...
		class62_1"(may affect network performance)";
		...
		class63_0"Works on all Windows editions. WinPcap/Npcap must be installed.";
		...
		class63_1"May work slow. May not work on some Windows Editions. May not work with firewalls.";
