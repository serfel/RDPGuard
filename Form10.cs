...
internal sealed class LicenseActivatationOfflineDialog : Form0
{
	private sealed class Class15
	{
		...
		{
			form10_0.method_11(object_0, eventArgs11_0);
		}
	}
	...
	private sealed class Class16
	{
		...
		internal void method_0()
		{
			form10_0.method_15(object_0, eventArgs11_0);
		}
	}
	...
	private void method_15(object sender, EventArgs11 e)
	{
		...
		@class.object_0 = sender;
		@class.eventArgs11_0 = e;
		Class89.eventHandler_8 = (EventHandler<EventArgs11>)Delegate.Remove(Class89.eventHandler_8, new EventHandler<EventArgs11>(method_15));
		if (base.InvokeRequired)
		{
			BeginInvoke(new Action(@class.method_0));
			return;
	...
	private void class66_0_Click(object sender, EventArgs e)
	{
		...
		{
			method_14("Unable to decode Activation Response.");
			return;
		}
		if (!(gClass.string_5 != "10.2.1") && gClass.long_0 == 5250827023818041824L)
		{
			...
			{
				Class89.eventHandler_8 = (EventHandler<EventArgs11>)Delegate.Combine(Class89.eventHandler_8, new EventHandler<EventArgs11>(method_15));
				Class89.smethod_12(gClass);
			}
			else
			{
				method_14("Activation Request and Activation Response are valid within one PC.");
			}
		}
		else
		{
			method_14("Activation Response is valid for RdpGuard version " + gClass.string_5 + " only.");
		}
	}
