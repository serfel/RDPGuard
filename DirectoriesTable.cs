...
internal sealed class DirectoriesTable : UserControl
{
	...
	{
		gclass0_0.ContextMenuStrip = RemoveCountry();
	}
	...
	private void InitializeComponent()
	{
		...
		this.toolStripButton_0.Text = "Delete";
		...
		this.toolStripButton_1.Text = "Edit";
		...
		this.toolStripButton_2.Text = "Add";
