...
internal sealed class HttpPostTaskAddEditControl : Control4
{
	...
	private void method_2()
	{
		...
		class63_3"Password for Basic HTTP Authentication";
		...
		class63_4"User name for Basic HTTP Authentication";
		...
		class63_2"Secure connection over SSL/TLS (HTTPS) is recommended if you enable this option";
		...
		class61_0"Enable Basic HTTP Authentication";
		...
		class63_1"Example https://server.com:8443/page.aspx";
