...
internal sealed class WebFormsSettingsDialog : Form0
{
	...
	private void InitializeComponent()
	{
		...
		class62_0"ASP.NET Web Forms Protection";
		...
		class62_1"ASP.NET web forms protection settings";
		...
		class61_0"Enable ASP.NET web forms protection";
		...
		class63_0"Turn on to enable ASP.NET web forms protection";
		...
		class63_1"Do not enable this feature if you are not sure. Please check online help.";
		...
		class62_2"Custom detection rules:";
		...
		class63_2"Enter custom detection rules. Please check online help for syntax.";
