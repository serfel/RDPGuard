...
internal sealed class OptionsDialog : Form0
{
	...
	private void method_19()
	{
		...
		class62_5"Reset counters of failed logon attempts after (hours):";
		...
		class63_2"Set the interval (in hours) after which the counters of failed logon attempts will be reset.";
		...
		class62_4"Unban IP addresses automatically after (hours):";
		...
		class63_1"Specify how long should attacker's IP address be blocked.";
		...
		class62_3"Maximum failed logon attempts from a single IP address:";
		...
		class63_0"How many failed logon attempts should be received before banning IP address.";
		...
		class62_0"RdpGuard will check for updates and notify you when new version available";
		...
		class61_0"Automatically check for software updates  ";
		...
		gclass3_0"advanced blocking settings..";
		...
		gclass2_0"Enable this option for preemptive blocking of IP addresses detected by other participants. Any attacks detected on your PC will also be reported to the cloud.";
		...
		class61_7"Enable RdpGuard IP Cloud";
		...
		class64_0"Allow specific countries (all other countries will be denied)";
		...
		class64_1"Deny specific countries (all other countries will have access)";
		...
		class63_4"Block or allow access to your server from specific countries.";
		...
		class63_5"Changing the theme requires an application restart to take effect.";
		...
		class62_13"Maximum number of IP addresses per page:";
		...
		class63_3"The number of IP addresses to show on a single page in the Blocked IP Addresses table";
		...
		class62_12"Hide RdpGuard to system tray when closed";
		...
		class61_5"Close to system tray";
		...
		class62_1"Hide RdpGuard to system tray when minimized";
		...
		class62_2"This check toggles whether RdpGuard has an icon in system tray";
		...
		class61_1"Always show RdpGuard icon in system tray";
		...
		class61_2"Minimize to system tray";
		...
		class61_4"My proxy server requires authentication";
		...
		class63_9"This option enables or disables logging of successful login attempts";
		...
		class61_10"Enable logging of successful login attempts";
		...
		class63_7"Specify the number of days after which old logs will be deleted.";
		...
		class61_9"Remove log files older than (days):";
		...
		class63_8"Choose the log detail level: verbose (detailed), brief (summarized), or errors and warnings only";
		...
		class63_6"If checked, all log messages will be saved to the log file,";
		...
		class61_8.Text = "Сохранить event log to file";
		...
		class62_15"Please keep the number of entries as short as possible,";
		...
		gclass3_1"click here for more details..";
