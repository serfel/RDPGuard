...
internal sealed class DashboardDialog : Form0
{
	...
	private void InitializeComponent()
	{
		...
		this.statusStrip_0.Text = "строка состояния";
		...
		this.menuStrip_0.Text = "главное меню";
		...
		this.toolStripMenuItem_0.Text = "Файл";
		...
		this.toolStripMenuItem_1.Text = "Выход";
		...
		this.toolStripMenuItem_5.Text = "Сервис";
		...
		this.toolStripMenuItem_6.Text = "Служба RdpGuard";
		...
		this.toolStripMenuItem_7.Text = "Запуск";
		...
		this.toolStripMenuItem_8.Text = "Остановить";
		...
		this.toolStripMenuItem_9"Перезапуск";
		...
		this.toolStripMenuItem_19.Text = "Белый список...";
		...
		this.toolStripMenuItem_23.Text = "Чёрный список...";
		...
		this.toolStripMenuItem_20.Text = "Разблокировать все IP-адреса";
		...
		this.toolStripMenuItem_21.Text = "Найти IP-адрес..";
		...
		this.toolStripMenuItem_22.Text = "Действия и уведомления";
		...
		this.toolStripMenuItem_10.Text = "Диагностика...";
		...
		this.toolStripMenuItem_11.Text = "Параметры...";
		...
		this.toolStripMenuItem_12.Text = "Справка";
		...
		this.toolStripMenuItem_13.Text = "Справка онлайн";
		...
		this.toolStripMenuItem_14.Text = "Контакты";
		...
		this.toolStripMenuItem_15.Text = "Проверка версий";
		...
		this.toolStripMenuItem_16.Text = "Купить RdpGuard";
		...
		this.toolStripMenuItem_17.Text = "Активация продукта";
		...
		this.toolStripMenuItem_18.Text = "О программе...";
