...
public class ListViewWithScroll : ListView
{
	...
	public ListViewWithScroll()
	{
		...
		{
			base.HandleCreated += ListViewWithScroll_HandleCreated;
			base.HandleDestroyed += ListViewWithScroll_HandleDestroyed;
		}
	}
	...
	public void method_7()
	{
		if (Class163.Class163_0.Boolean_0 && !bool_0)
		{
			...
			if (View.Details == base.View && base.Columns.Count >= 1)
			{
				...
				base.DrawColumnHeader += ListViewWithScroll_DrawColumnHeader;
				DrawListViewItemEventHandler value = _003C_003Ec._003C_003E9.method_4;
				base.DrawItem += value;
				base.DrawSubItem += ListViewWithScroll_DrawSubItem;
				bool_0 = true;
			}
		}
	}
	...
	private void ListViewWithScroll_HandleCreated(object sender, EventArgs e)
	{
		IntPtr intptr_ = Class181.SendMessage(base.Handle, 4127u, IntPtr.Zero, IntPtr.Zero);
		class49_0 = new Class49(intptr_, this);
	}

	private void ListViewWithScroll_HandleDestroyed(object sender, EventArgs e)
	{
		class49_0?.ReleaseHandle();
	}

	private void ListViewWithScroll_DrawColumnHeader(object sender, DrawListViewColumnHeaderEventArgs e)
	{
	...
	private void ListViewWithScroll_DrawSubItem(object sender, DrawListViewSubItemEventArgs e)
	{
		if (e.Item.Selected)
		{
