...
internal sealed class Pop3MonitoringViaLogsControl : Control2
{
	...
	public GEnum10 GEnum10_0
	{
		get
		{
			return Class194.Class194_0[mcbServerType.Text];
		}
		set
		{
			mcbServerType.Text = Class194.Class194_0[value];
		}
	}
	...
	private void AddTask()
	{
		...
		case GEnum10.const_0:
			...
			mlblLogFilesLocationHint.Text = "Specify log files directory, usually C:\\Program Files (x86)\\Mail Enable\\Logging\\POP";
			break;
		...
		case GEnum10.const_3:
			mlblLogFilesLocation.Text = "Log files directory:";
			medLogFileOrDirectory.bool_0 = true;
			medLogFileOrDirectory.String_1 = "C:\\Program Files\\Microsoft\\Exchange Server\\V15\\Logging\\Pop3";
			mlblLogFilesLocationHint.Text = "Specify log files directory, usually C:\\Program Files\\Microsoft\\Exchange Server\\V15\\Logging\\Pop3)";
	...
	private void InitializeComponent()
	{
		...
		mlblLogFilesLocationHint.TabIndex = 148;
		...
		mlblServerTypeHint.Size = new Size(326, 16);
		mlblServerTypeHint.TabIndex = 145;
		mlblServerTypeHint.Text = "Select POP3 server software installed on the machine.";
		...
		mcbServerType.Size = new Size(566, 24);
		...
		mlblServerType.Size = new Size(88, 16);
		mlblServerType.TabIndex = 143;
		mlblServerType.Text = "POP3 Server:";
