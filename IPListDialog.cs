...
internal sealed class IPListDialog : Form0
{
	...
	private void InitializeComponents()
	{
		...
		using (form)
		{
			...
			{
				class46_0.InitializeComponents(form.IPListEntry_0);
			}
		}
	}
	...
	{
		class46_0.InitializeComponents(iplistEntry_0);
	...
	private void OnCheckedChanged()
	{
		...
		using (openFileDialog)
		{
			if (DialogResult.OK == openFileDialog.ShowDialog())
			{
				...
				case 2:
					class46_0.InitializeComponents(method_21(openFileDialog.FileName));
					break;
				case 1:
					class46_0.InitializeComponents(OnSelectedIndexChanged(openFileDialog.FileName));
					break;
				}
			}
		}
	...
	private void method_24()
	{
		...
		class62_1.Text = "{TOP_DESCRIPTION}";
		...
		toolStripDropDownButton_0.Text = "More..";
		...
		toolStripMenuItem_0.Text = "Import..";
		...
		toolStripMenuItem_1.Text = "Export..";
		...
		toolStripMenuItem_2.Text = "Move up";
		...
		toolStripMenuItem_3.Text = "Move down";
