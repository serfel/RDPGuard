...
internal sealed class SmtpSettingsDialog : Form0
{
	...
	private void InitializeComponent()
	{
		...
		class62_1"Configure SMTP protection settings";
		...
		class65_0"Select monitoring method for SMTP protocol:";
		...
		class63_0"Works with particular SMTP server's logs, SSL/TLS connections are supported.";
		...
		class63_1"Works with any SMTP Server. SSL/TLS connections are not supported.";
		...
		class63_2"Turn on to enable SMTP protection";
		...
		class61_0"Enable SMTP protection";
