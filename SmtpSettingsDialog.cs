...
internal sealed class SmtpSettingsDialog : Form0
{
	...
	private void InitializeControls()
	{
		...
		panel_0.Controls.Add(control13_0);
	}
	...
	private void WireUpEvents()
	{
		...
		control13_0.Event_1 += method_17;
		control13_0.Event_0 += method_18;
	...
	private void ReInitializeComponent()
	{
		...
		control13_0.Enabled = flag && class64_0.Checked;
		control13_0.Visible = class64_0.Checked;
		gclass3_1.Enabled = flag && class64_0.Checked;
		gclass3_1.Visible = class64_0.Checked;
		if (class64_1.Checked)
		{
		...
		if (class64_0.Checked)
		{
			class66_0.Enabled = !flag || control13_0.Boolean_0;
		}
	}
	...
	private void InitializeComponent()
	{
		...
		class62_0.Size = new Size(109, 16);
		class62_0.TabIndex = 49;
		class62_0.Text = "Параметры SMTP";
		...
		class62_1.Size = new Size(216, 16);
		class62_1.TabIndex = 48;
		class62_1.Text = "Configure SMTP protection settings";
		...
		class65_0.Text = "Select monitoring method for SMTP protocol:";
		class63_0.AutoSize = true;
		class63_0.ForeColor = SystemColors.ControlDarkDark;
		class63_0.Location = new Point(12, 108);
		class63_0.Name = "m_lblProtocolMonitoring_LogBasedHint";
		class63_0.Size = new Size(475, 16);
		class63_0.TabIndex = 113;
		class63_0.Text = "Works with particular SMTP server's logs, SSL/TLS connections are supported.";
		class63_1.AutoSize = true;
		class63_1.ForeColor = SystemColors.ControlDarkDark;
		class63_1.Location = new Point(12, 55);
		class63_1.Name = "m_lblProtocolMonitoring_TrafficBasedHint";
		class63_1.Size = new Size(426, 16);
		class63_1.TabIndex = 112;
		class63_1.Text = "Works with any SMTP Server. SSL/TLS connections are not supported.";
		...
		class63_2.Name = "m_lblEnableSmtpProtectionHint";
		class63_2.Size = new Size(214, 16);
		class63_2.TabIndex = 112;
		class63_2.Text = "Turn on to enable SMTP protection";
		class61_0.AutoSize = true;
		class61_0.Location = new Point(4, 3);
		class61_0.Name = "m_chbEnableSmtpEngine";
		class61_0.Size = new Size(172, 20);
		class61_0.TabIndex = 111;
		class61_0.Text = "Enable SMTP protection";
		...
		gclass3_1.Location = new Point(9, 587);
		gclass3_1.Name = "m_lnkAdvancedSmtpSettings";
		gclass3_1.RightToLeft = RightToLeft.No;
		gclass3_1.Size = new Size(123, 16);
		gclass3_1.TabIndex = 113;
	...
	{
		class66_0.Enabled = control13_0.Boolean_0;
	}
