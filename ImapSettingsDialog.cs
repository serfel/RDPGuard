...
internal sealed class ImapSettingsDialog : Form0
{
	...
	private void InitializeComponent()
	{
		...
		class62_1"Configure IMAP protection settings";
		...
		class65_0"Select monitoring method for IMAP protocol:";
		...
		class63_0"Works with particular IMAP server's logs, SSL/TLS connections are supported.";
		...
		class63_1"Works with any IMAP Server. SSL/TLS connections are not supported.";
		...
		class63_2"Turn on to enable IMAP protection";
		...
		class61_0"Enable IMAP protection";
