...
internal sealed class MailSendTaskAddEditControl : Control4
{
	...
	{
		base.Boolean_0 = !string.IsNullOrEmpty(class0_0.Text) && !string.IsNullOrEmpty(textBox_1.Text) && !string.IsNullOrEmpty(textBox_0.Text) && !string.IsNullOrEmpty(textBox_2.Text) && !string.IsNullOrEmpty(textBox_3.Text) && vInitializeComponent();
