...
internal sealed class EditableGeoIPCountriesTable : UserControl
{
	...
	private sealed class Class4
	{
		...
		{
			control0_0.method_7(object_0, eventArgs0_0);
		}
	}
	...
	private void method_3()
	{
		...
		using (form)
		{
			if (DialogResult.OK == form.ShowDialog())
			{
				control1_0.method_3(form.IPListEntry_0);
			}
		}
	}
	...
	{
		method_8(bool_4: true);
		Class89.eventHandler_28 = (EventHandler<EventArgs0>)Delegate.Combine(Class89.eventHandler_28, new EventHandler<EventArgs0>(method_7));
		Class89.smethod_39(geoIPDBVersion_0);
	}

	private void method_7(object sender, EventArgs0 e)
	{
		Class4 @class = new Class4();
		@class.control0_0 = this;
		@class.object_0 = sender;
		@class.eventArgs0_0 = e;
		Class89.eventHandler_28 = (EventHandler<EventArgs0>)Delegate.Remove(Class89.eventHandler_28, new EventHandler<EventArgs0>(method_7));
	...
	private void InitializeComponent()
	{
		...
		this.toolStripButton_2.Text = "Изменить";
