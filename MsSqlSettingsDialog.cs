...
internal sealed class MsSqlSettingsDialog : Form0
{
	...
	private void InitializeComponent()
	{
		...
		class62_1"Advanced MS-SQL protection settings";
		...
		class61_0"Enable MS-SQL protection";
		...
		class63_0"Turn on to enable MS-SQL protection";
		...
		class62_2"In most cases this event indicates brute-force attacks, keep it enabled";
		...
		class61_1"Monitor Event ID 18456";
		...
		class62_3"This event may also be a part of an attack on MS-SQL server";
		...
		class61_2"Monitor Event ID 17832";
		...
		class62_4"This event may also be a part of an attack on MS-SQL server";
		...
		class61_3"Monitor Event ID 17836";
